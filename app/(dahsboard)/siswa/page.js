  ...
  return (
    <div className="page-container">
      ...
      <div className="breadcrumb">
        ...
        <span className="current">Siswa</span>
      </div>
      ...
      <div className="page-header">
        <div className="page-header-row">
          <div>
            <h1>👥 Data Siswa</h1>
            <p>Pilih kelas untuk melihat dan mengelola daftar siswa</p>
          </div>
          <a href="/kelas" className="btn btn-secondary btn-sm">
            + Tambah Kelas
          </a>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="card">
          <div className="empty-state">
            ...
            <p>Buat kelas terlebih dahulu sebelum mengelola data siswa</p>
        ...
        <div style={{
          ...
          {kelasList.map(kelas => (
            <button
              key={kelas.id}
              onClick={() => router.push(`/siswa/${kelas.id}`)}
              style={{
                textAlign: 'left',
